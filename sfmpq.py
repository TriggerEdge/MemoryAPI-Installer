...
if hasattr(sys, 'frozen'):
    SFmpq_DIR = os.path.join(os.path.dirname(unicode(sys.executable, sys.getfilesystemencoding())),'bin')
else:
...
def MpqDeleteFile(mpq, file):
    return _SFmpq.MpqDeleteFile(mpq, file)
